...
Third-party patches are essential for keeping theis TextMate Bundle great. We want to keep it as easy as possible to contribute changes. There are a few guidelines that we need contributors to follow so that we can have a chance of keeping on top of things.
...
* Submit a pull request to the repository NBi (Seddryck/stream-analytics-query-language-tmBundle).
